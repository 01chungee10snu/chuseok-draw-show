...
**[럭키드로우 열기](https://01chungee10snu.github.io/chuseok-draw-show/)** · v1.0.1
...
Box2D 코스는 10ms 고정 스텝, 회전 장애물, 초반 가속, 카메라 추적, 결승 감속과 정체 복구를 사용합니다. 기본 연출은 12초, 여유 있는 진행은 18초이며 물리 코스는 최대 7초 더 기다릴 수 있습니다. 카메라의 실제 표시 확대는 가독성을 위해 2.4배로 제한합니다. 탭을 숨기거나 일시정지한 시간은 연출 시간에서 제외합니다. 느린 화면에서도 경과 시간을 반영하되, 한 프레임에 최대 1초만 반영해 여러 초를 한꺼번에 건너뛰지 않도록 합니다. 움직임 줄이기를 선택하거나 운영체제에서 해당 설정을 켜면 2.4초의 정적인 공개 연출을 사용합니다.
...
- [설계 결정](docs/DECISIONS.md), [v1.0 검수](docs/QA_v1.0.md), [v1.0.1 재생 검수](docs/QA_v1.0.1.md), [변경 이력](CHANGELOG.md)
